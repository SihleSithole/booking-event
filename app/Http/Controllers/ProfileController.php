...
class ProfileController extends Controller
{
    ...
    public function userUpdateView(Request $request): View
    {
        // Retrieve the user by the provided $id, or fail if not found
        $user = User::findOrFail($request->user_ids);
